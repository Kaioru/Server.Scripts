selection = self.ask_menu("Now...ask me any questions you may have on traveling!!", {
	[0] = "How do I move?",
	...
	[8] = "What should I do to become a Thief?",
	[9] = "What should I do to become a Magician?",
	[10] = "What should I do to become a Pirate?",
	[11] = "How do I raise the character stats?",
	[12] = "How do I check the items that I just picked up?",
	[13] = "How do I put on an item?",
	[14] = "How do I check out the items that I'm wearing?",
	[15] = "What are skills?",
	[16] = "How do I get to Victoria Island?",
	[17] = "What are mesos?"
})
...
elseif selection == 5 then
	...
	self.say("Oh yeah! One last piece of information before I go. If you are not sure where you are, always press #bW#k. The world map will pop up with the locator showing where you stand. You won't have to worry about getting lost with that.")
...
elseif selection == 10 then
	self.say("Do you wish to become a #bPirate#k? In order to make a job advancement, you MUST head to Victoria Island. Head to the #bNautilus#k, a strange-looking submarine currently docked on the island, head inside, and find #bKyrin#k. She'll help you with the rest.")
	self.say("By the way! Don't forget you have to be over level 10 and over 20 DEX to become a pirate!!")
